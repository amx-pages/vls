          ...
          <div className="col-md-8">
            <div className="card shadow-lg border-0">
              ...
              <div className="card-body">
                <h2 className="card-title mb-3 text-center">German Course</h2>
                <p className="card-text text-center">
                  Master the German language as spoken in Austria. Focus on the local dialects and Austrian culture.
                </p>
                <div className="course-details mt-4">
                  <p><strong>Course Title:</strong> German Language for Beginners to Intermediate</p>
                ...
                <div className="card shadow-sm">
                  <div className="card-body">
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li><strong>2.</strong> Understand and use essential vocabulary and grammar.</li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <div className="card shadow-sm">
                  <div className="card-body">
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li><strong>4.</strong> Gain cultural insights into German-speaking countries.</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="accordion" id="courseStructureAccordion">
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingWeek1">
                  <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseWeek1" aria-expanded="true" aria-controls="collapseWeek1">
                    Week 1–2: Introduction to German
                  </button>
                </h2>
              ...
              <div className="accordion-item">
                ...
                <div id="collapseWeek9" className="accordion-collapse collapse" aria-labelledby="headingWeek9" data-bs-parent="#courseStructureAccordion">
                  <div className="accordion-body">
                    <ul>
                      <li>Modal verbs (e.g., können, müssen).</li>
                      <li>Introduction to past tense (Perfekt).</li>
